    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <span class="label label-primary pull-right"></span>
                ...
                <li class="treeview <?php if($_GET['pa']=='history_kasub_pengguna') { ?> active <?php } ?>">
                    <a href="index.php?p=history_kasub_table&pa=history_kasub_pengguna" style="<?php if($_GET['pa']=='history_kasub_pengguna') { ?>
                            background-color: #c7fff1; opacity: 80%
                    <?php } ?>">
