...
$query = mysqli_query($koneksi, "SELECT MAX(kode_brg) from stokbarang WHERE id_jenis=2");
...
if ($kode_brg) {
    ...
    $kode = $kode + 1;
    $kode_otomatis = "112.".str_pad($kode, 3, "0", STR_PAD_LEFT);                   
    
    
} else {
   $kode_otomatis = "112001";
}
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post"  action="add-proses-m2.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select id="jenis_brg" required="isikan dulu" class="form-control" name="id_jenis">
                                    ...
                                    $queryJenis = mysqli_query($koneksi, "select * from jenis_barang WHERE id_jenis=2");
                            ...
                            <div class="form-group">
                                ...
                                &nbsp;
                                <input type="reset" class="btn btn-danger" value="Batal">                    <a href="index.php?p=material-m2&id_jenis=2" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>  
