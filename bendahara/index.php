    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="index.php?p=user&pa=DataUser" style="<?php if ($datauser == "active") { ?>
                            background-color: #c7fff1; opacity: 80% <?php } ?>"><i class="fa fa-users"></i>
                        <span>Data User</span>
                    </a>
                </li>
                <!--                <li class="treeview active" style="">-->
                <li class="treeview
                <?php if ($_GET['pas'] == 'atk' || $_GET['pas'] == 'alatkebersihan' || $_GET['pas'] == 'perlengkapanlainnya' || $_GET['pas'] == 'olipelumas' || $_GET['pas'] == 'sparepart') { ?>
                active
                <?php
                }
                ?>"
                    ...
                    <a href="index.php?pa=DataStokBarang"
                       style="<?php if ((isset($_GET['pas']) && $_GET['pas'] == 'atk') || (isset($_GET['pas']) && $_GET['pas'] == 'alatkebersihan') || (isset($_GET['pas']) && $_GET['pas'] == 'perlengkapanlainnya') || (isset($_GET['pas']) && $_GET['pas'] == 'olipelumas') || (isset($_GET['pas']) && $_GET['pas'] == 'sparepart')) { ?>background-color: #c7fff1; opacity: 85%<?php } ?>">
                    ...
                    <ul class="treeview-menu">
                        <?php
                            ...
                            foreach ($query_get_kategori as $index=>$value){
                                ...
                                <li style="<?php if ($_GET['pas'] == $trimmed_nama_kategori) { ?> background-color: #87b2a4 <?php } ?>">
          ...
          <span class="label label-primary pull-right"></span>
                ...
                <li class="treeview <?php if ($_GET['pas'] == 'formpengajuan' || $_GET['pas'] == 'datapengajuan') { ?> active <?php } ?>">
                    <a href="index.php?pa=PengajuanBarang"
                       style="<?php if ((isset($_GET['pas']) && $_GET['pas'] == 'formpengajuan') || (isset($_GET['pas']) && $_GET['pas'] == 'datapengajuan')) { ?>background-color: #c7fff1; opacity: 85%<?php } ?>">
          ...
          <span class="label label-primary pull-right"></span>
                    ...
                    <ul class="treeview-menu">
                        <li style="<?php if ($_GET['pas'] == 'formpengajuan') { ?> background-color: #87b2a4 <?php } ?>">
                ...
                <li class="treeview <?php if ($_GET['pas'] == 'detil_lap_permintaan' || $_GET['pas'] == 'rekapitulasipermintaan') { ?> active <?php } ?>">
          ...
          <span class="label label-primary pull-right"></span>
                    ...
                    <ul class="treeview-menu">
                        <li style="<?php if ($_GET['pas'] == 'detil_lap_permintaan') { ?> background-color: #87b2a4 <?php } ?>">
                ...
                <li class="treeview <?php if ($_GET['pas'] == 'detil_lap_pengajuan' || $_GET['pas'] == 'rekapitulasipengajuan') { ?> active <?php } ?>">
          ...
          <span class="label label-primary pull-right"></span>
                    ...
                    <ul class="treeview-menu">
                        <li style="<?php if ($_GET['pas'] == 'detil_lap_pengajuan') { ?> background-color: #87b2a4 <?php } ?>">
