        ...
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Editt Data Permintaan Barang</h3>
                </div>
                <form method="post"  action="edit_prosesminta_pengguna.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <a href="index.php?p=detilpermintaan&unit=<?php echo $unit?>&tgl=<?php echo $tgl_permintaan?>&user_id_pemohon=<?php echo $user_id_pemohon?>&bendahara_id=" style="margin:10px;" class="btn btn-success">
