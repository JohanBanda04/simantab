...
WHERE pengajuan_sementara.unit='$_SESSION[username]' and 
pengajuan_sementara.user_id='$_SESSION[user_id]' AND pengajuan_sementara.tgl_pengajuan 
BETWEEN '$tanggala' and '$tanggalb' ");
...
//  $data2 = mysqli_fetch_array($query2);
  ...
  <table class="tabel2">
    <tr>
        <td style="text-align: center; width=382px;"><b>Sub Total</b></td>
        <td style="text-align: center; width=50px;"><b><?php echo number_format($total_jumlah); ?> </b></td>
        <td style="text-align: center; width=90px;"><b>Rp.<?php echo number_format($total_harga_barang) ?>.- </b></td>
