    ...
    <div class="col-sm-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-2">
              <a href="index.php?p=tambahmaterial-m3" class=" btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Stok</a><br>						
            </div>
            ...
            <tr>
             ...
             if (mysqli_num_rows($query)) {
               while($row=mysqli_fetch_assoc($query)):
                ...
                <td>
                  <a href="?p=edit-m3&aksi=edit&id=<?= $row['kode_brg']; ?>"><span data-placement='top' data-toggle='tooltip' title='Update'><button  class="btn btn-info">Update</button></span></a>                     

                  <a href="?p=material-m3&aksi=hapus&id=<?= $row['kode_brg']; ?>"><span data-placement='top' data-toggle='tooltip' title='Hapus'><button  class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus ?')">Hapus</button></span></a>                    
                </td>              					
              </tr>
              <?php $no++; endwhile; } ?>
            </tbody>
