                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                        <div class="box box-primary">
                            ...
                            <form method="post" action="edit-proses-m2.php" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group ">
                                        <label for="kode_brg" class="col-sm-offset-1 col-sm-3 control-label">Kode
                                            Barang</label>
                                        <div class="col-sm-4">
                                            <input type="text" readonly value="<?= $row2['kode_brg']; ?>"
                                                   class="form-control" name="kode_brg">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="kode_brg" class="col-sm-offset-1 col-sm-3 control-label">
                                            Barang Keluar</label>
                                        <div class="col-sm-4">
                                            <input type="text" readonly value="<?= $row2['keluar']; ?>"
                                            ...
                                            <select id="jenis_brg" required="isikan dulu" class="form-control"
                                                ...
                                                if (mysqli_num_rows($queryJenis)) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($queryJenis)):
                                                        ...
                                                        ?>
                                                        <option <?php if ($row2['id_jenis'] == $row['id_jenis']) echo "selected"; ?>
                                    ...
                                    <div class="form-group">
                                        <label id="tes" for="nama_brg" class="col-sm-offset-1 col-sm-3 control-label">Nama
                                            Barang</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" value="<?= $row2['nama_brg']; ?>"
                                                   name="nama_brg">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control"
                                                   value="<?= $row2['hargabarang']; ?>" name="hargabarang">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="jumlah"
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" value="<?= $row2['satuan']; ?>"
                                                   name="satuan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="jumlah"
                                               class="col-sm-offset-1 col-sm-3 control-label">Jumlah</label>
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control" value="<?= $row2['stok']; ?>"
                                                   name="jumlah">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" value="<?= $row2['keterangan']; ?>"
                                                   name="keterangan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" name="update" class="btn btn-primary col-sm-offset-4 "
                                               value="Simpan">
                                        &nbsp;
