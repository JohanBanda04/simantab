...
<!--			<img src="gambar/SiKerang-Icon.png" style="width: 300px; height: 150px;">-->
			<img src="gambar/Simantabs.png" style="width: 200px; height: 150px; border-radius: 20%">
			<form method="post">
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-user" style="color: orange"></i></span>
						<input type="text" class="form-control" placeholder="Username" name="username" required  />
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-unlock" style="color: #0f74a8"></i></span>
						<input  type="password" class="form-control" placeholder="Password" name="password"  required>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group col-md-7">
						<span class="input-group-addon"><i class="fa fa-shield" style="color: #0e0e4e"></i></span>
...
//                                ?>
				...
				<div class="row" style="border-radius: 25px;">
					<div class="col-xs-12" style="border-radius: 20%;">
						<input type="submit" style="background-color:#a6251e;"
